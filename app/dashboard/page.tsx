...
import { Upload, Edit, Download, Eye, Award } from "lucide-react";
      ...
      <div className="flex">
        ...
        <aside className="w-64 bg-white h-screen p-4">
          <nav className="space-y-2">
            <Link
              href="/dashboard"
              className="block px-4 py-2 rounded-md bg-gray-100 text-gray-700"
            >
              Dashboard
            </Link>
            <Link
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  <p>
                    <strong>Name:</strong> {profileInfo.firstName}{" "}
                  ...
                  <p>
                    ...
                    {profileInfo.signature ? "Uploaded" : "Not uploaded"}
                  </p>
                  <Link href="/profile">
            ...
            <CardContent>
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  {
                    name: "First Form Zap",
                    description: "Completed first form",
                  },
                  {
                    name: "Speed Zapper",
                    description: "Completed a form in under 5 minutes",
                  },
                  {
                    name: "Perfectionist",
                    description: "Completed 5 forms without errors",
                  },
                ].map((badge, index) => (
